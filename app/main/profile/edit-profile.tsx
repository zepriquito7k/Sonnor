...
export default function EditProfileScreen() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      Alert.alert("Erro", "Nao foi possivel guardar o perfil.");
    } finally {
      setSaving(false);
    }
  }
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Perfil publico</Text>
      ...
      >
        ...
        <Text style={styles.label}>Estilos que gostas</Text>
        ...
        <View style={styles.privacyBox}>
          <Text style={styles.privacyTitle}>Ocultar no perfil</Text>
          {[
            { field: "birthDate" as const, label: "Ano/data de nascimento" },
            { field: "location" as const, label: "Pais e cidade" },
            { field: "interests" as const, label: "Categorias que gosto" },
          ].map((item) => (
            <View key={item.field} style={styles.switchRow}>
              ...
              <Switch
                ...
                trackColor={{ false: "#333", true: "#6F8FAF" }}
                thumbColor="#fff"
              />
            </View>
          ))}
...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 96, paddingHorizontal: 20, paddingTop: 48, flexDirection: "row", alignItems: "center" },
  backButton: { width: 42, height: 42, alignItems: "flex-start", justifyContent: "center" },
  title: { flex: 1, color: "#fff", fontSize: 22, fontWeight: "900", textAlign: "center" },
  content: { paddingHorizontal: 22, paddingBottom: 150 },
  label: { color: "#fff", fontSize: 16, fontWeight: "900", marginTop: 20, marginBottom: 10 },
  input: { minHeight: 56, borderRadius: 14, paddingHorizontal: 15, paddingVertical: 12, color: "#fff", fontSize: 16, fontWeight: "800", backgroundColor: "#111", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", marginBottom: 10 },
  textArea: { minHeight: 108, textAlignVertical: "top" },
  searchBox: { minHeight: 54, borderRadius: 14, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "#f4f4f4", marginBottom: 14 },
  searchInput: { flex: 1, color: "#111", fontSize: 16, fontWeight: "900" },
  chipGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  chip: { minHeight: 44, borderRadius: 22, paddingHorizontal: 15, flexDirection: "row", alignItems: "center", gap: 7, backgroundColor: "#181818", borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  chipSelected: { backgroundColor: "#6F8FAF", borderColor: "#6F8FAF" },
  chipText: { color: "#fff", fontSize: 14, fontWeight: "900" },
  chipTextSelected: { color: "#000" },
  privacyBox: { borderRadius: 18, padding: 14, backgroundColor: "rgba(255,255,255,0.055)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", marginTop: 24 },
  privacyTitle: { color: "#fff", fontSize: 17, fontWeight: "900", marginBottom: 8 },
  switchRow: { minHeight: 52, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  switchText: { flex: 1, color: "#ddd", fontSize: 15, fontWeight: "800" },
  footer: { position: "absolute", left: 0, right: 0, bottom: 0, minHeight: 112, paddingHorizontal: 22, paddingTop: 14, paddingBottom: 34, backgroundColor: "#000" },
  saveButton: { minHeight: 58, borderRadius: 29, alignItems: "center", justifyContent: "center", backgroundColor: "#6F8FAF" },
  saveText: { color: "#000", fontSize: 18, fontWeight: "900" },
