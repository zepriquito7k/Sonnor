...
export default function ManageReleasesScreen() {
  const [releases, setReleases] = useState<string[]>(["A carregar releases..."]);
  ...
  async function loadData() {
    ...
    try {
      ...
      Alert.alert("Erro", "Nao foi possivel carregar os lancamentos.");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <View style={styles.root}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>Albuns e musicas publicados na app.</Text>
...
const styles = StyleSheet.create({
  ...
  refreshButton: { alignSelf: "flex-start", flexDirection: "row", gap: 8, minHeight: 42, borderRadius: 16, paddingHorizontal: 14, alignItems: "center", backgroundColor: "rgba(255,255,255,0.08)", marginBottom: 18 },
  refreshText: { color: "#fff", fontWeight: "700" },
  sectionTitle: { color: "#fff", fontSize: 20, fontWeight: "900", marginTop: 10, marginBottom: 12 },
  card: { borderRadius: 22, padding: 18, backgroundColor: "rgba(255,255,255,0.055)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", marginBottom: 14 },
  cardTitle: { color: "#fff", fontSize: 16, fontWeight: "800", marginBottom: 8 },
  meta: { color: "#aaa", fontSize: 12, marginTop: 3 },
